...
const checkout = () => {
  return (
    ...
    //       <p class="mb-4"><span id="enteredFirstName">Cha</span> <span id="enteredLastName">Ji-Hun C</span>
      ...
      <div class="nav nav-sidebar mb-2">
        ...
        <div className="col-md-6 border-right">
            <div className="p-3 py-5">
                ...
                <h4 class="m-b-50 heading-line">Notifications <i class="fa fa-bell text-muted"></i></h4>
                </div>
